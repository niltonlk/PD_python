...
# create network 
net_layer = PD_python.Network(N=N, fname='spike_recorder_fix_delay.txt')
...
plt.xlim([600,800])
# save figure
plt.savefig('raster_plot_fix_delay.png', dpi=300)
...
plt.xticks(fontsize=18)
plt.savefig('box_plot_fix_delay.png', dpi=300)
